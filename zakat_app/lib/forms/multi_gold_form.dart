...
class MultiGoldForm extends StatefulWidget {
  const MultiGoldForm({super.key});

  @override
  State<MultiGoldForm> createState() => _MultiGoldFormState();
}

class _MultiGoldFormState extends State<MultiGoldForm> {
